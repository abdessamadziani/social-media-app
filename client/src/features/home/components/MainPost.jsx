              ...
              <div className='flex items-center  '>
                   <div className='text-gray-900'>
                     <label className="cursor-pointer "  htmlFor="file">
                      ...
                      <input type="file" id='file' name='file' className='hidden' onChange={(e)=>setFile(e.target.files[0])} />
                      </label>
                   </div>
                   ...
                   <div className='text-gray-900 mx-4'>
                    ...
                    <div className='text-gray-900'>
                    <label className="cursor-pointer"  htmlFor="file2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z" />
                      </svg>
                      <input type="file" id='file2' name='file2' className='hidden' onChange={(e)=>setFile2(e.target.files[0])} />
                    </label>
                    </div>
